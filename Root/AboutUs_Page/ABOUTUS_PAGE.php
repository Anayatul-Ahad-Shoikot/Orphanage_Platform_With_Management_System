...
<head>
    ...
    <link rel="stylesheet" href="/Root/AboutUs_Page/ABOUTUS_PAGE_STYLE.css" />
    <title>CareSenerity.org | About-us page</title>
</head>
...
<body>
    <header class="header">
        <nav id="fixedNav">
            <div class="logo">
            <a href="/Root/Landing_Page/INDEX.php"><img src="/Root/Landing_Page/LOGO_NoBackground.png" alt="LOGO"  height="45px"></a>
            </div>
            <div class="links">
                <ul>
                    <li><a href="/Root/Landing_Page/INDEX.php">Home</a></li><p id="H-bar"></p>
                    <li><a href="#">Donate</a></li><p id="H-bar"></p>
                    <li><a href="#">Gallary</a></li><p id="H-bar"></p>
                    <li><a href="/Root/AboutUs_Page/ABOUTUS_PAGE.php" class="active">About Us</a></li><p id="H-bar"></p>
