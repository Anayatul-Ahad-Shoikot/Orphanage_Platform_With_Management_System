...
<head>
    ...
    <link rel="stylesheet" href="/Root//D & A//Adoptions//U_CONFIRMATION_WINDOW_STYLE.css">
...
<body>
    ...
    <div class="confirmation">
        <div class="main">
            <h1>Thank You!</h1>
            <p>Your application has been submitted successfully. We will review your information and contact you within 24 hours to confirm the adoption process.</p>
            <button><a href="/Root/D & A/Adoptions/U_ADOPTION_DASH.php">OK</a></button>
        </div>
    </div>
</body>
</html>