    ...
    include('/xampp/htdocs/DBMS_Project_Organized_One/Includes/db_con.php');
        ...
        if (isset($_POST['update'])) {
                ...
                if (isset($_POST['org_name']) && !empty($_POST['org_name'])) {
                    ...
                    $SQL = "UPDATE org_details SET org_name = ? WHERE org_id = ? LIMIT 1";
                ...
                if (isset($_POST['contact_email']) && !empty($_POST['contact_email'])) {
                    ...
                    $SQL = "UPDATE org_details SET contact_email = ? WHERE org_id = ? LIMIT 1";
                    $stmt = mysqli_prepare($con, $SQL);
                ...
                if (isset($_POST['contact_phone']) && !empty($_POST['contact_phone'])) {
                    ...
                    $SQL = "UPDATE org_details SET contact_phone = ? WHERE org_id = ? LIMIT 1";
                    $stmt = mysqli_prepare($con, $SQL);
                ...
                if (isset($_POST['established_date']) && !empty($_POST['established_date'])) {
                    ...
                    $SQL = "UPDATE org_details SET established_date = ? WHERE org_id = ? LIMIT 1";
                    $stmt = mysqli_prepare($con, $SQL);
                ...
                if (isset($_POST['description']) && !empty($_POST['description'])) {
                    ...
                    $SQL = "UPDATE org_details SET description = ? WHERE org_id = ? LIMIT 1";
                    $stmt = mysqli_prepare($con, $SQL);
                ...
                if (isset($_POST['website']) && !empty($_POST['website'])) {
                    ...
                    $SQL = "UPDATE org_details SET website = ? WHERE org_id = ? LIMIT 1";
                    $stmt = mysqli_prepare($con, $SQL);
                ...
                if (isset($_POST['address']) && !empty($_POST['address'])) {
                    ...
                    $SQL = "UPDATE org_details SET address = ? WHERE org_id = ? LIMIT 1";
                    $stmt = mysqli_prepare($con, $SQL);
                ...
                if (isset($_POST['location']) && !empty($_POST['location'])) {
                    ...
                    $SQL = "UPDATE org_details SET location = ? WHERE org_id = ? LIMIT 1";
                    $stmt = mysqli_prepare($con, $SQL);
                ...
                if (isset($_POST['country']) && !empty($_POST['country'])) {
                    ...
                    $SQL = "UPDATE org_details SET country = ? WHERE org_id = ? LIMIT 1";
                    $stmt = mysqli_prepare($con, $SQL);
                ...
                if (isset($_POST['mission_and_vision']) && !empty($_POST['mission_and_vision'])) {
                    ...
                    $SQL = "UPDATE org_details SET mission_and_vision = ? WHERE org_id = ? LIMIT 1";
                    $stmt = mysqli_prepare($con, $SQL);
                ...
                if (isset($_FILES["image"]["name"]) && !empty($_FILES["image"]["name"])) {
                    ...
                    $SQL="UPDATE org_details SET logo_path = '$image_path' WHERE org_id='$Name' LIMIT 1";
                    mysqli_query($con, $SQL);
                }
                header("Location: /Root/Admin_Side/Dash/Organizations/VIEW_ORG.php?org_id=$Name");
            } else {
