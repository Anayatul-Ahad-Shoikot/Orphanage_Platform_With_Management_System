...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['query'])) {
    ...
    if (!empty($search)) {
        ...
        $query = "SELECT * FROM orphan_list WHERE first_name LIKE '%$search%' OR last_name LIKE '%$search%' OR age = '$search' OR gender='$search' OR religion LIKE '%$search%' OR adoption_status LIKE '%$search%'";
