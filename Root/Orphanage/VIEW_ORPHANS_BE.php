<?php
    ...
    if (mysqli_num_rows($result2) > 0) {
        while ($row2 = mysqli_fetch_assoc($result2)) {
            ...
            echo '<a href="/Root/Orphanage/REMOVE_ORPHAN_BE.php?orphan_id=' . $row2['orphan_id'] . '" class="message">Remove</a>';
            echo '<a href="/Root/Orphanage/ORPHAN_PROFILE.php?orphan_id=' . $row2['orphan_id'] . '" class="message"> View </a>';
            echo '</div>';
            echo '</div>';
        }
    } else {
