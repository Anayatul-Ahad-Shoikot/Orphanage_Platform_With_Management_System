...
(11, 17, 24, 'orphan', 'card', 'sabrina@gmail.com', '3454', '6655', 'january', '2030', NULL, NULL, 1000000),
(12, 17, 24, 'orphan', 'card', 'sabrina@gmail.com', '3454', '6655', 'january', '2030', NULL, NULL, 1000000);
...
(21, 'DhakaFoundation', 1004, 'Dhaka Foundation is a non-profit organization dedicated to supporting orphaned children and providing care for the elderly. They focus on creating a loving and nurturing environment for both generations.', 'dhakafoundation@example.com', '+8801712345678', 'www.dhakafoundation.org', 'img/DhakaFoundation_657034a53c5c9.png', '2000-02-12', 'Dhaka', 'Empower every orphan and elder', NULL),
...
--
ALTER TABLE `local_orphan_guardian`
  MODIFY `guardian_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `orphan_list`
  MODIFY `orphan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
